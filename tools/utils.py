...
tf.app.flags.DEFINE_string('train_data_pattern', 'train-%d-of-01024', 'Training tfrecord filename')
tf.app.flags.DEFINE_string('val_data_pattern', 'validation-%d-of-00128', 'Validation tfrecord filename')
...
tf.app.flags.DEFINE_integer('num_classes', 1001, 'Number of classes in ImageNet, plus one for Null class')
...
def load_batch(shards=TRAIN_SHARDS, train=True, batch_size=FLAGS.batch_size, num_epochs=FLAGS.num_epochs):
